...
\hline
$D, D_a$ &\multicolumn{6}{|l}{the set of all arrived demands and admitted demands}\\
%\hline
...
\hline
$v_t^\bm{z}$ &\multicolumn{6}{|l}{whether tunnel $t$ is available under a failure scenario $\bm{z}$}\\
% \hline
...
$f_i^t$& \multicolumn{6}{|l}{bandwidth allocated for the $i$-th demand over tunnel $t$}\\
\hline
$h_i$& \multicolumn{6}{|l}{profit (after refunding) from providing service for demand $i$}\\
%\hline
%\hline
