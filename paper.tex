...
\caption{BA demands arrive with poisson process and their duration are with exponential distribution.}
\label{e2}
\end{figure*}
...
\includegraphics[width=0.23\textwidth]{fig/evaluation/fixed-scheduling.pdf}}
\subfigure[Fixed admission control]{
\includegraphics[width=0.23\textwidth]{fig/evaluation/no-fixed.pdf}}
