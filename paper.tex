...
\section{The $\mathsf{TEDAT}$ framework}\label{HATE}
In this section, we discuss the details of $\mathsf{TEDAT}$, which contains three parts, i.e., admission control, traffic scheduling and failure recovery, using notations summarized in Table \ref{Notation}. 
...
\caption{System architecture of $\mathsf{TEDAT}$.}
\label{pic-overview}
\end{center}
\end{figure}
