...
For example, the inter-DC WAN contains four links $E=\{e_1,e_2,e_3,e_4\} $ shown in Figure \ref{motivatio_fig}. 
Network scenario $\{1,1,0,1\}$ means $e_1$ ,$e_2$, $e_4$ are available and  $e_3$ fails.
The up probability of $e_1,e_2,e_3,e_4$ are 96\%, 99.9999\%, 99.9\%, 99.9999\%, respectively.
Then its probability $p(\{1,1,0,1\}) =0.96\times0.999999\times0.001\times0.999999\simeq 0.000959998$.
...
%<<<<<<< HEAD
%then we say this BA demand is \textbf{satisfied} by this exact allocation result. 
%=======
%then we say this BA demand is satisfied by this exact allocation result in a sensen of expectation. 
%>>>>>>> 7d80e71feb4d10a0f1449a95f5e091001064f259
