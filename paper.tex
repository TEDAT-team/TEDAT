...
\textit{Third}, 
such heterogeneities and competitions are either not considered by their failure recovery approaches, especially those who allocate bandwidth aggressively \cite{Teavar,swan}, therefore, services may run into congestions when traffic is rerouted under network failures. 
