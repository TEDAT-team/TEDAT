...
and the average profit loss is around 10\% and it can save at least 90\% time (more details can be seen in Appendix \ref{testbed-appendix}).
...
Figure \ref{sim-time}  shows that the optimal solution which is derived by bruce force algorithm is at least 9 $\times$ larger than our greedy failure recovery algorithm.
\end{appendices}
