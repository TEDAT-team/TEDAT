...
On the other hand, compared with the latest TE schemes like FFC and TEAVAR,   $\mathsf{TEDAT}$ can meet the availability SLAs for 40\% more bandwidth demands, and when network failure causes SLA violations, it can retain 30\% more profit  under a simple pricing and refunding model.
%.
% $\mathsf{TEDAT}$ can 
...
(4)  $\mathsf{TEDAT}$ is fast and accuracy enough to use in large scale network.
...
\begin{figure} 
   \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \includegraphics[width=1.8 in]{fig/evaluation/routing.pdf}
    \caption{Routings.} 
    \label{routing-version} 
  \end{minipage}% 
   \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \includegraphics[width=1.8 in]{fig/evaluation/approximation.pdf}
