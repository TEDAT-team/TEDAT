...
set terminal pdfcairo font "Gill-Sans,20" size 3,3
...
set xlabel "Testbed/Simulation availability"
set ylabel "CDF"
...
set key samplen 1
set key at graph 1.04,0.1

set xrange [0.9:1.1]
set yrange [0:1]


plot "cdf.txt" u 2:1 title "TEDAT" w l ls 1  smooth bezier, '' u 4:1 title "TEAVAR" w l ls 2 dashtype '-' smooth bezier ,'' u 3:1 title "FFC" w l ls 5 dashtype '.' smooth bezier 
