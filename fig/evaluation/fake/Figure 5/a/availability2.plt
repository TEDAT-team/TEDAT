...
plot "availability.txt" u 2:xtic(1) w histogram fill solid t "TEDAT"  ls 1, '' u 3:xtic(1) t "TEAVAR" w histogram fill solid ls 2, '' u 4:xtic(1) t "FFC" w histogram fill solid ls 5
