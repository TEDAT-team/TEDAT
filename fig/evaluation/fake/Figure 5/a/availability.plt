...
plot "availability.txt" u 2:xtic(1) w histogram fillstyle pattern 1 t "TEDAT"  ls 1, '' u 3:xtic(1) t "TEAVAR" w histogram fillstyle pattern 2 ls 2, '' u 4:xtic(1) t "FFC" w histogram fillstyle pattern 4 ls 5
