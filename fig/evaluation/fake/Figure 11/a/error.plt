...
plot "error.txt" u 2:xtic(1) w histogram fillstyle pattern 1 t "10^{-3}"  ls 1, '' u 3:xtic(1) t "10^{-4}" w histogram fillstyle pattern 2 ls 2, '' u 4:xtic(1) t "10^{-5}" w histogram fillstyle pattern 4 ls 3,'' u 5:xtic(1) t "10^{-6}" w histogram fillstyle pattern 5 ls 4
