...
set arrow 1 from graph 0.5,0.8 to graph 0.58,0.8 lw 2
set label "353" at graph 0.41,0.8

set arrow 2 from graph 0.8,0.8 to graph 0.72,0.7 lw 2
set label "956" at graph 0.82,0.8
...
plot "optimizer_times.txt" u 2:xtic(1) w histogram fillstyle pattern 1 t "Greedy-10^{-3}"  ls 1, '' u 3:xtic(1) t "Gurobi-10^{-3}" w histogram fillstyle pattern 2 ls 2,'' u 4:xtic(1) t "Greedy-10^{-6}" w histogram fillstyle pattern 4 ls 3,'' u 5:xtic(1) t "Gurobi-10^{-6}" w histogram fillstyle pattern 5 ls 4
