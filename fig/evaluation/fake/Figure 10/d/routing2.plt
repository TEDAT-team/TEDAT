...
plot \
	'routing.txt' u 2:xtic(1) t "Oblivious" ls 1 fillstyle pattern 1, '' u 3:xtic(1) t "Edge-disjoint" ls 2 fillstyle pattern 2,'' u 4:xtic(1) t "KSP-3" ls 3 fillstyle pattern 4