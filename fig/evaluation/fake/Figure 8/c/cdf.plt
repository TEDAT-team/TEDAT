...
set output "availability-cdf.pdf"
...
plot "cdf.txt" u 1:2 title "TEDAT" w lp ls 1, '' u 1:3 title "TEAVAR" w lp ls 2  ,'' u 1:4 title "SMORE" w lp ls 3,'' u 1:5 title "SWAN" w lp ls 4,'' u 1:6 title "FFC" w lp ls 5 
