...
set style line 5 lt rgb "#500050" lw 0.6 pt 12 ps 1.5
set style line 6 lt rgb "#000000" lw 0.6 pt 13 ps 1.5
...
plot \
	'weightvalue.txt' u 2:3:xtic(1) t "TEDAT" ls 1 fill solid , '' u 4:5:xtic(1) t "TEAVAR" ls 2 fill solid,'' u 6:7:xtic(1) t "SMORE" ls 3 fill solid,'' u 8:9:xtic(1) ls 4  t "SWAN" fill solid,'' u 10:11:xtic(1) ls 5 t "FFC" fill solid