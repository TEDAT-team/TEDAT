...
set output "averagebandwidth.pdf"
...
plot "averagebandwidth.txt" u 2:xtic(1) w histogram t "TEDAT"  ls 1, '' u 3:xtic(1) t "TEAVAR" w histogram ls 2, '' u 4:xtic(1) t "SWAN" w histogram ls 3
