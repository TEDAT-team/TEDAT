...
set output "topologyutilization2.pdf"
...
plot \
	'topologyutilization2.txt' u 2:3:xtic(1) notitle  ls 6, '' u 4:5:xtic(1) notitle ls 1,'' u 6:7:xtic(1) notitle ls 2,'' u 8:9:xtic(1) ls 5 fill solid notitle