...
set xtics ("3" 0, "6" 1, "9" 2,"12" 3,"16" 4)
...
set output "sameweight.pdf"
plot \
	'sameweight.txt' u 2:3:xtic(1) w histogram ls 1 t "Satisfaction ratio" axis x1y1,\
	'' u 4 w line smooth csplines lt rgb "#00A000"  lw 1 notitle axis x1y2,\
	'' u 4:5:xtic(1) w errorbar  ls 2 t "Total Profit" axis x1y2