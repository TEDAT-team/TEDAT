...
set output "weightnumber.pdf"


set xlabel "Important profit"
set ylabel "CDF"
...
plot "weightnumber.txt" u 1:2 title "|W|=4" w lp ls 1  smooth sbezier, '' u 1:3 title "|W|=6" w lp ls 2 smooth sbezier,'' u 1:4 title "|W|=8" w lp ls 3 smooth sbezier
