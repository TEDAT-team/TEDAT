...
we can define $B_d^{\bm{z}}\times p_{\bm{z}}$  as the potential achieved availability of $d$ under network scenario  $\bm{z}$.
...
failure recovery problem and consider a special case, in which $\mu_d=0,\forall d \in D_a$.
